          ...
          <>
            <div className="bg-white rounded-xl shadow-sm p-4 md:p-6 hover:shadow-md transition-shadow">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-2 md:gap-3">
                ...
                <div className="flex-1 w-full">
                  <label className="text-xs md:text-sm font-medium text-gray-700 block md:mb-2">Content Niche</label>
                  <input
                    type="text"
                    value={niche}
            ...
            <div className="bg-white rounded-xl shadow-sm p-4 md:p-6 hover:shadow-md transition-shadow">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-2 md:gap-3">
                ...
                <div className="flex-1 w-full">
                  <label className="text-xs md:text-sm font-medium text-gray-700 block md:mb-2">Target Audience</label>
                  <input
                    type="text"
                    value={audience}
          ...
          <>
            <div className="bg-white rounded-xl shadow-sm p-4 md:p-6 hover:shadow-md transition-shadow">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-2 md:gap-3">
                ...
                <div className="flex-1 w-full">
                  <label className="text-xs md:text-sm font-medium text-gray-700 block md:mb-2">Product Niche</label>
                  <input
                    type="text"
                    value={niche}
                    onChange={(e) => setNiche(e.target.value)}
          ...
          <>
            <div className="bg-white rounded-xl shadow-sm p-4 md:p-6 hover:shadow-md transition-shadow">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-2 md:gap-3">
                ...
                <div className="flex-1 w-full">
                  <label className="text-xs md:text-sm font-medium text-gray-700 block md:mb-2">Business Niche</label>
                  <input
                    type="text"
                    value={niche}
                    onChange={(e) => setNiche(e.target.value)}
