...
const GeneratorHeader: React.FC<GeneratorHeaderProps> = ({ 
  ...
  return (
    <div className="text-center mb-8">
      <h1 className="text-4xl md:text-4xl font-bold text-[#1EAEDB] mb-4">Video Idea Generator</h1>
      ...
      {hasIdeas && setActiveTab && (
        <div className="flex justify-center mt-6 space-x-2">
          <Button
            ...
            className={`text-sm ${activeTab === 'input' ? 'bg-[#1EAEDB] hover:bg-[#0FA0CE]' : ''}`}
          >
            Input Form
          </Button>
          <Button
            ...
            className={`text-sm ${activeTab === 'ideas' ? 'bg-[#1EAEDB] hover:bg-[#0FA0CE]' : ''}`}
          >
            View Ideas
          </Button>
        </div>
