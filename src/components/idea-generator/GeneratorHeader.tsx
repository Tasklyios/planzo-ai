...
const GeneratorHeader: React.FC<GeneratorHeaderProps> = ({ 
  ...
  return (
    <div className="text-center mb-8">
      <h1 className="text-4xl md:text-4xl font-bold text-[#9b87f5] mb-4">Video Idea Generator</h1>
      ...
      {hasIdeas && setActiveTab && (
        <div className="flex justify-center mt-6 space-x-2">
          <Button
            ...
            className={`text-sm ${activeTab === 'input' ? 'bg-[#9b87f5] hover:bg-[#7E69AB]' : ''}`}
          >
            Input Form
          </Button>
          <Button
            ...
            className={`text-sm ${activeTab === 'ideas' ? 'bg-[#9b87f5] hover:bg-[#7E69AB]' : ''}`}
          >
            View Ideas
          </Button>
        </div>
