...
const GeneratorHeader: React.FC<GeneratorHeaderProps> = ({ 
  ...
  return (
    <div className="text-center mb-8">
      <h1 className="text-4xl md:text-4xl font-bold text-[#0051FF] mb-4">Video Idea Generator</h1>
      ...
      {hasIdeas && setActiveTab && (
        <div className="flex justify-center mt-6 space-x-2">
          <Button
            ...
            className={`text-sm ${activeTab === 'input' ? 'blue-gradient' : ''}`}
          >
            Input Form
          </Button>
          <Button
            ...
            className={`text-sm ${activeTab === 'ideas' ? 'blue-gradient' : ''}`}
          >
            View Ideas
          </Button>
        </div>
