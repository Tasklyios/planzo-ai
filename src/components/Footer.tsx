      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h4 className="text-xl font-bold mb-4 text-primary">Planzo AI</h4>
            <p className="text-gray-500">AI-powered video content creation made simple. Generate ideas, scripts, and plan your content.</p>
