      ...
      <DialogContent className="max-w-7xl p-0 gap-0">
        <div className="min-h-[800px] bg-gradient-to-b from-[#F9FAFC] to-[#F2F4F8] px-4 py-12">
          ...
          <div id="pricing-cards" className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
            <div id="pro-plan" className="bg-white rounded-2xl p-8 shadow-lg transform transition-all duration-300 hover:-translate-y-2">
            ...
            <div id="business-plan" className="bg-white rounded-2xl p-8 shadow-lg transform transition-all duration-300 hover:-translate-y-2">
              <div className="text-center mb-8">
