...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "duration-200 flex shrink-0 items-center rounded-md px-2 text-xs font-medium text-muted-foreground outline-none transition-[margin,opacity] ease-linear [&>svg]:size-4 [&>svg]:shrink-0",
